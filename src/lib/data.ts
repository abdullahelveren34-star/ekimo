...
export const departmentMembers: { [key: string]: Employee[] } = {
  ...
  'Mali İşler': [
    { id: '38', name: 'Bahar Candan', title: 'Mali İşler Direktörü', department: 'Mali İşler', email: 'bahar.candan@e-kimo.com', phone: '555-123-4561', avatarUrl: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', birthDate: '1978-11-05', annualLeave: { total: 26, used: 15, remaining: 11 }, equipment: [] },
